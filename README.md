...
- **Когниция** — паттерны, эмоции, решения, proactive, traits.
- **Тело** — Android через Termux. Голос, слух, батарея, сенсоры.
- **Сеть** — UDP discovery + TCP. Подписи.
- **Квесты** — создание, делегирование.
- **Экономика** — SYM, $10/день.
- **Ночная работа** — разбор дня.
