...
</style></head><body><main class="shell"><aside class="side"><div class="brand"><i class="orb"></i><div><h1 id="name">Арсений</h1><p>Личный цифровой спутник</p></div></div><p class="online">Локально работает</p><div class="stat"><b>Модель</b><span id="model">Проверяем…</span></div><div class="stat"><b>Память</b><span id="memory">—</span></div><div class="stat"><b>Версия ядра</b><span id="core">—</span></div><p class="hint">Ваши сообщения остаются на этом компьютере. Арсений использует локальную модель.</p></aside><section class="chat"><header class="top"><strong>Диалог с Арсением</strong><span class="badge">личная память</span></header><div id="messages" class="messages"><div class="message"><small>Арсений</small>Привет. Я готов к разговору. Что для вас сейчас важно?</div></div><form class="composer" id="form"><input id="text" autocomplete="off" placeholder="Напишите Арсению…" autofocus><button>Отправить</button></form></section></main><script>
